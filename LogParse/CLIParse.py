...
def main():
    ...
    parser.add_argument("log_format", choices=["apache", "iis", "syslog", "cef", "pcap", "yara"],
                        help="Log format to parse (e.g., 'apache', 'iis', 'syslog', 'cef', 'pcap', 'yara')")
    parser.add_argument("-p", "--path", required=True, help="Path to the log file to parse")
    parser.add_argument("-o", "--output", help="Path to the output directory (default: current working directory)")
