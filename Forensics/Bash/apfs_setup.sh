...
# Set up links
echo "build complete"
ln /opt/apfs-fuse/build/apfs-dump /usr/bin/apfs-dump
ln /opt/apfs-fuse/build/apfs-dump-quick /usr/bin/apfs-dump-quick
ln /opt/apfs-fuse/build/apfs-fuse /usr/bin/apfs-fuse
ln /opt/apfs-fuse/build/apfsutil /usr/bin/apfsutil
